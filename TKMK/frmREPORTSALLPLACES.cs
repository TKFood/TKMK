    ...
    public partial class frmREPORTSALLPLACES : Form
    {
        ...
        public StringBuilder SETSQL(string SDATES, string EDATES)
        {
            ...
            SB.AppendFormat(@" 
                            ...
                            ,(SELECT ISNULL(SUM(TA026),0) FROM  [TK].dbo.POSTA TA WHERE TA.TA001=POSTA.TA001 AND TA.TA002=POSTA.TA002 AND (TA009 LIKE '68%' OR TA009 LIKE '69%' )) AS 'GROUPMONEYS'
                            ,(SUM(TA026)-(SELECT ISNULL(SUM(TA026),0) FROM  [TK].dbo.POSTA TA WHERE TA.TA001=POSTA.TA001 AND TA.TA002=POSTA.TA002 AND (TA009 LIKE '68%' OR TA009 LIKE '69%' ) ) ) AS 'VISITORMONEYS'
