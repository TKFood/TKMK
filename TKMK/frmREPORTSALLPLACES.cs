    ...
    public partial class frmREPORTSALLPLACES : Form
    {
        ...
        public StringBuilder SETSQL_DAILY1(string SDATES)
        {
            ...
            SB.AppendFormat(@"                              
                            ...
                            ,ISNULL((SUM(TA026)-(ISNULL((SELECT SUM(TA026) FROM [TK].dbo.POSTA TA1 WHERE TA1.TA001=POSTA.TA001 AND TA1.TA002=POSTA.TA002 AND (TA008 LIKE '68%' OR TA008 LIKE '69%' )),0)))-(SELECT SUM(TB031) FROM [TK].dbo.POSTB WHERE TB001=TA001 AND TB002=TB002 AND TB010 LIKE '406%'),0) AS '散客業績'
